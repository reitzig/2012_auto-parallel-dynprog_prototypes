...
/**
 * Implements Diagonal Frontier scheme by sleeping while a cell can not be computed.
 *
 * @author Raphael Reitzig, 02.2012
 * @deprecated Inferior to {@link CellCheckWait}
 */
@Deprecated
public class CellCheckSleep extends DiagonalFrontier {
  /**
   * Creates a new instance
   * @param p The number of workers this solver will use. Has to be positive.
   */
  public CellCheckSleep(final int p) {
    super(p);
  }
