 ...
 */
public class BlockCheckWaitTest extends DiagonalFrontierTest {
  public BlockCheckWaitTest() {
    super(new BlockCheckWait(Runtime.getRuntime().availableProcessors(), 5),
          new BlockCheckWait(Runtime.getRuntime().availableProcessors()),
          new BlockCheckWait());
  }
