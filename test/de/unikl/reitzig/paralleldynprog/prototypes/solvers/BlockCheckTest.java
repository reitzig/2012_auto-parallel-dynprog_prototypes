 ...
 */
public class BlockCheckTest extends DiagonalFrontierTest {
  public BlockCheckTest() {
    super(new BlockCheck(Runtime.getRuntime().availableProcessors(), 5),
          new BlockCheck(Runtime.getRuntime().availableProcessors()),
          new BlockCheck());
  }
