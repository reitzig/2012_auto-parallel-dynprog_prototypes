 ...
 */
public class ColumnBlockTest extends DiagonalFrontierTest {
  public ColumnBlockTest() {
    super(new ColumnBlock(Runtime.getRuntime().availableProcessors(), 5, 5),
          new ColumnBlock(Runtime.getRuntime().availableProcessors(), 5),
          new ColumnBlock());
  }
