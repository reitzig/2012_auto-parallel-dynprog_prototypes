 ...
 */
public class BlockCheckSleepTest extends DiagonalFrontierTest {
  public BlockCheckSleepTest() {
    super(new BlockCheckSleep(Runtime.getRuntime().availableProcessors(), 5),
          new BlockCheckSleep(Runtime.getRuntime().availableProcessors()),
          new BlockCheckSleep());
  }
